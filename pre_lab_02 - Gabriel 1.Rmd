...
**Answer: R observed the expenditures for each month from the first day of the month and listed the months based on their expenditures from the highest to the lowest.**
...
1.  group all Maryland expenditures based on the names of their payees

2.  how much was spent in Maryland for the money paid by 'Pizza'?

3.  filter all journalism courses above \*600\* and group them in categories based on the number of seats occupied.
