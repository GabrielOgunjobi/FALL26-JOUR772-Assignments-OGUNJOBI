...
**Q3** Count the number of courses for each instructor and department. Which instructor has taught the most? **A3 I xxx**

```{r}
umd_courses |>
  group_by (instructors) |>
  summarise(
    mean_instructors = mean(instructors)
  ) |>
  arrange(desc(mean_instructors))
