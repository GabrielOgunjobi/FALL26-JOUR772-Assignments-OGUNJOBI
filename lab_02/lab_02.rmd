...
**Q1.** How many departments have offered the courses with "Climate" in the title and at least one seat? Which department has offered the most? **A1. Atmospheric and Oceanic Science, with 93 seats.**

```{r}
climate_course <- umd_courses |>
  group_by(department) |>
  filter(str_detect(title, "Climate") & seats >= 1)|>
    summarise(climateword =n()) |>
    arrange (desc(climateword))
    
  
  
```

**Q2.** Of the departments listed in A1, which one is the most interesting to you, and why? **A2. Honors, I do not understand the correlation between climate and Honors and why it would have 9 seats.**
...
wes_moore <- maryland_expenses |>
  ...
  filter(str_detect(committee_name, "Wes For"))|>
